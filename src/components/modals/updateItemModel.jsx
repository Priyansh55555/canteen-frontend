...
import { Upload, XCircle, Loader, X, Pencil } from "lucide-react";
import { zfd } from "zod-form-data";
import toast from "react-hot-toast";
import { extractMessageFromError } from "../../utils/errorHandler";
import { useUpdateFood } from "../../hooks/useAdmin";
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Update Food Item</h2>
              <p className="text-xs text-gray-500">Modify the details below</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto">
            <form id="update-food-form" onSubmit={handleSubmit(onSubmit)} className="px-6 py-5 space-y-5">
